	...
	pdfBytes, err := renderCardPDF(renderInput{
		...
		Event: events.EventResponse{
			EventSummary: events.EventSummary{
				Name: "Annual Conference", StartDate: "2026-03-01", EndDate: "2026-03-02", Venue: &venue,
			},
		...
		SubEvents: []subEventSchedule{
			{Name: "Workshop Day", Days: []events.EventDayResponse{{Date: "2026-03-01", EntryTime: "10:00", ExitTime: "12:00"}}},
		},
		QRToken: "test-token",
	})
	if err != nil {
