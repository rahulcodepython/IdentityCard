...
//
// Days reuses EventDayInput/EventDayResponse — same wire shape, same
// date/time formats. An empty Days list means the sub-event runs on every
// day of the parent event, using the parent's own times.
