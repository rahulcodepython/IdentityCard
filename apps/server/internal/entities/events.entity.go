...
// mode uses — see internal/utils/timeutil for the "2006-01-02" / "15:04"
// formats.
...
// fields are required depends on it (validated further in
// EventsService.Create, since a cross-field rule like "flash requires
// exactly one Days entry" isn't cleanly expressible as a struct tag alone):
...
// after publish (see EventsService.Publish's doc comment) — adding an
...
// CSV import shape, applied here to day/exclusion-date rows instead of
// people rows.
