...
// Mirrors apps/server/internal/modules/people/dto.go. email/mobile are
// only present on create — they key the upsert server-side and can't be
// changed afterward (see the Go DTO comment).
...
export const personResponseSchema = z.object({
  ...
  card_sent_at: z.string().nullable(),
