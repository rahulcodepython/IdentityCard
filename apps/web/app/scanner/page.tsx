...
import type { ScannerMe, ScanResponse } from "@/lib/validation/scanner"

import { ScanResultCard } from "./scan-result-card"

// The scanner-bot's one and only route (per the spec): a big "Scan"
// button, camera opens, first successful decode of the day records
// entry, the next records exit — see attendance.Service.Scan on the
// backend for the actual verify/entry/exit logic this just displays.
